...
const addAdditionalTerm = () => {
  ...
  console.log('After addAdditionalTerm:', contract.value.additionalTerms);
...
const removeAdditionalTerm = (index) => {
  ...
  console.log('After removeAdditionalTerm:', contract.value.additionalTerms);
        ...
        <el-form label-position="top" :model="contract" class="custom-form">
          ...
          <div class="section-title mt-4 flex-between">
            ...
            <div class="title-left">
              ...
              <span>4. QUY TRÌNH THỰC HIỆN</span>
          ...
          <el-table
              :data="contract.additionalTerms.map((t, i) => ({ index: i, content: t }))"
              border
              style="width: 100%"
              :show-header="contract.additionalTerms.length > 0"
          >
            ...
            <el-table-column label="Nội dung quy trình">
              <template #default="{ row }">
                <el-input
                    v-model="contract.additionalTerms[row.index]"
            ...
            <el-table-column label="Thao tác" width="80" align="center">
              <template #default="{ row }">
                <el-button
                    ...
                    circle
                    size="small"
                    @click="removeAdditionalTerm(row.index)"
                    plain
                />
              </template>
            </el-table-column>
            ...
            <template #empty>
              <div style="padding: 12px; color: #909399; font-size: 13px;">
                Chưa có quy trình nào. Nhấn "+ Thêm quy trình" để bổ sung.
              </div>
            </template>
          </el-table>
          ...
          <div class="section-title mt-4">
            ...
            <span>5. THÔNG TIN NGƯỜI MẤT</span>
          ...
          <div class="section-title mt-4">
            ...
            <span>6. THÔNG TIN GIẤY BÁO TỬ VÀ THỜI GIAN HỢP ĐỒNG</span>
          ...
          <div class="section-title mt-4">
            ...
            <span>7. THÔNG TIN NƠI AN TÁNG</span>
