...
public class KhachHangService {
    ...
    public KhachHangResponse create(KhachHangRequest request, Integer maNhanVienDangNhap) {
        KhachHang khachHang = KhachHang.builder()
                ...
                .soNhaDuong(trim(request.getSoNhaDuong()))
                .phuongXa(trim(request.getPhuongXa()))
                .quanHuyen(trim(request.getQuanHuyen()))
                .tinhThanh(trim(request.getTinhThanh()))
    ...
    private KhachHangResponse toResponse(KhachHang kh, Integer maNhanVien) {
        ...
        return KhachHangResponse.builder()
                ...
                .cccd(kh.getCccd())
                .diaChi(kh.getDiaChi())
                .soNhaDuong(kh.getSoNhaDuong())
                .phuongXa(kh.getPhuongXa())
                .quanHuyen(kh.getQuanHuyen())
                .tinhThanh(kh.getTinhThanh())
                .email(kh.getEmail())
    ...
    private KhachHangResponse toQuanLyResponse(
        ...
        return KhachHangResponse.builder()
                ...
                .soNhaDuong(khachHang.getSoNhaDuong())
                .phuongXa(khachHang.getPhuongXa())
                .quanHuyen(khachHang.getQuanHuyen())
                .tinhThanh(khachHang.getTinhThanh())
