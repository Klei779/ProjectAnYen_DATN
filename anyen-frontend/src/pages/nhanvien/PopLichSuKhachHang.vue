    ...
    <div class="history-popup">
      ...
      <div class="history-header">
        <div class="history-header-info">
          ...
          <h3>
            {{ props.customer?.tenKhachHang || "Khách hàng" }}
          </h3>

          <span>
            {{ props.customer?.soDienThoai || "Chưa có SĐT" }}

            <template v-if="props.customer?.email">
      ...
      <div class="customer-summary-box">
        <div class="summary-item">
          ...
          <b>
            {{ props.customer?.trangThaiHienTai || "---" }}
          </b>
        </div>
        ...
        <div class="summary-item">
          ...
          <b>
            {{ props.customer?.giaiDoanHienTai || "---" }}
          </b>
        </div>
      ...
      <div class="history-body">
        ...
        >
          ...
          >
            <div
                class="timeline-icon"
                :class="classByType(item.loai)"
            >
              <i
                  class="fa-solid"
                  :class="iconByType(item.loai)"
              ></i>
            </div>
...
/*
 * Khôi phục font của Font Awesome.
 * Phần này giúp icon không bị biến thành ô vuông
 * khi CSS bên ngoài đang dùng font-family !important.
 */
